...
% chi-aug
sen4a = [0,1,1,0.97758,0.99103,0.96861,0.96413,0.93274,0.91031,0.88789,...
    0.86099,0.81166,0.74439,0.49776,0.40807,0.36323];
fpR4a = [0,1,0.98143,0.75295,0.861,0.58638,0.36972,0.16601,0.071469,0.037141,...
    0.014069,0.0011255,0.00056275,0.002251,0.0016882,0.0011255];
...
plot(sort(fpR4a),sort(sen4a),'c:','LineWidth',1.6); 
...
auc.AUC1_chi_idm_aug = trapz(sort(fpR4a),sort(sen4a));
...
c2a = '$\chi^2$-detector with IDM Aug ([1,1])';
c3 = '$\chi^2$-detector without IDM ([1,1])';
legend(c1,c2,c2a,c3,'Location','southeast','Interpreter','latex');
% [0.1,0.1]
% ocsvm
...
% chi aug
sen4a = [0,1,0.95964,0.95067,0.94619,0.94619,0.9417,0.93722, 0.92825,...
    0.91928,0.89686,0.87892,0.84753,0.73543,0.62332,0.34978];
fpR4a = [0,1,0.97411,0.95554,0.92065,0.86269,0.78616,0.68092,0.54418,...
    0.41137,0.26055,0.148,0.083286,0.039392,0.014069,0.0078784];
